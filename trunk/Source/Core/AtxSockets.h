...
#define ATX_ERROR_TIMEOUT            (ATX_ERROR_BASE_SOCKETS - 5)
#define ATX_ERROR_BIND_FAILED        (ATX_ERROR_BASE_SOCKETS - 6)
#define ATX_ERROR_LISTEN_FAILED      (ATX_ERROR_BASE_SOCKETS - 7)
#define ATX_ERROR_ACCEPT_FAILED      (ATX_ERROR_BASE_SOCKETS - 8)
#define ATX_ERROR_SELECT_FAILED      (ATX_ERROR_BASE_SOCKETS - 9)
...
ATX_BEGIN_INTERFACE_DEFINITION(ATX_Socket)
    ATX_Result (*Bind)(ATX_SocketInstance*      instance, 
                       const ATX_SocketAddress* address);
    ATX_Result (*Connect)(ATX_SocketInstance*      instance, 
                          const ATX_SocketAddress* address,
                          ATX_Timeout              timeout);
    ATX_Result (*GetInputStream)(ATX_SocketInstance* instance, 
                                 ATX_InputStream*    stream);
    ATX_Result (*GetOutputStream)(ATX_SocketInstance* instance, 
                                  ATX_OutputStream*   stream);
    ATX_Result (*GetInfo)(ATX_SocketInstance* instance, 
                          ATX_SocketInfo*     info);
...
ATX_INTERFACE(object)->Bind(ATX_INSTANCE(object), address)

#define ATX_Socket_Connect(object, address, timeout) \
ATX_INTERFACE(object)->Connect(ATX_INSTANCE(object), \
                               address,              \
                               timeout)
...
ATX_BEGIN_INTERFACE_DEFINITION(ATX_DatagramSocket)
    ATX_Result (*Send)(ATX_DatagramSocketInstance* instance,
                       const ATX_DataBuffer*       packet, 
                       const ATX_SocketAddress*    address);
    ATX_Result (*Receive)(ATX_DatagramSocketInstance* instance,
...
ATX_INTERFACE(object)->Send(ATX_INSTANCE(object), packet, address)

#define ATX_ServerSocket_Receive(object, packet, address) \
ATX_INTERFACE(object)->Receive(ATX_INSTANCE(object), packet, address)
...
ATX_BEGIN_INTERFACE_DEFINITION(ATX_ServerSocket)
    ATX_Result (*Listen)(ATX_ServerSocketInstance* instance,
                         unsigned int              max_clients);
    ATX_Result (*WaitForNewClient)(ATX_ServerSocketInstance* instance,
                                   ATX_Socket*               client);
...
ATX_INTERFACE(object)->Listen(ATX_INSTANCE(object), max_clients)

#define ATX_ServerSocket_WaitForNewClient(object, client) \
ATX_INTERFACE(object)->WaitForNewClient(ATX_INSTANCE(object), client)
