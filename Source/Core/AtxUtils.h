...
|    byte I/O
+---------------------------------------------------------------------*/
extern void ATX_BytesFromInt32Be(unsigned char* buffer, unsigned long value);
extern void ATX_BytesFromInt16Be(unsigned char* buffer, unsigned short value);
extern unsigned long ATX_BytesToInt32Be(const unsigned char* buffer);
extern unsigned short ATX_BytesToInt16Be(const unsigned char* buffer);

extern void ATX_BytesFromInt32Le(unsigned char* buffer, unsigned long value);
extern void ATX_BytesFromInt16Le(unsigned char* buffer, unsigned short value);
extern unsigned long ATX_BytesToInt32Le(const unsigned char* buffer);
extern unsigned short ATX_BytesToInt16Le(const unsigned char* buffer);
...
#else
extern int ATX_CopyString(char* dst, const char* src);
#endif
...
#define ATX_StringsEqualN(s1, s2, n) \
(strncmp((s1), (s2), (n)) == 0)
#else
